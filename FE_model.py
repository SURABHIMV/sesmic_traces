...
##df['rolling_median_input_signal'] = df['input_filtered_merged'].rolling(window=10, min_periods=1).median()
...
folder_path = "/media/mleng/HDD/projects2023/Surabhi_seismic/data/EXP/EXP4_4"

# List all input train data and output batch in the folders
trace_files = [f for f in os.listdir(folder_path)]

#storing the batch of input and its features in subfolder and storing the predicted and actual output in separate folder
