...
df['rolling_R_input_merge_mean'] = realFFT_inm.rolling(window=10, min_periods=1).mean()
df['rolling_R_input_merge_std'] = realFFT_inm.rolling(window=10, min_periods=1).std()
df['rolling_R_input_merge_max'] = realFFT_inm.rolling(window=10, min_periods=1).max()
df['rolling_R_input_merge_min'] = realFFT_inm.rolling(window=10, min_periods=1).min()
df['rolling_R_input_merge_var'] = realFFT_inm.rolling(window=10, min_periods=1).var()
...
folder_path = "/media/mleng/HDD/projects2023/Surabhi_seismic/data/EXP/EXP4_1"
